...
<head>
    ...
    <link rel="stylesheet" href="${basePath}/css/common/base.css.css"/>
...
<div class="page-container">
    ...
    <form id="_form" action="" method="post">
        ...
        <button type="button" class="btn-primary" id="login">登录</button>
        <button type="button"id="register" class="btn-blue">Register</button>
